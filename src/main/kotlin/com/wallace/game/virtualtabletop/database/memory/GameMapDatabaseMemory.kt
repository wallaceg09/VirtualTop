...
class GameMapDatabaseMemory {
    ...
    @PostConstruct
    private fun init() {
        val file = File(javaClass.classLoader.getResource("static/debug_room.json").file)
        ...
        maps.add(GameMap(UUID.fromString("242eceff-3ce0-4e23-9183-a63de7cbf66e"), json, "debug_map", mutableMapOf(Pair("color_tileset_16x16_Jerom&Eiyeron_", "test"))))
    }
